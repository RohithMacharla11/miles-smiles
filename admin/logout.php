...
if (isset($_POST['logout_btn'])) {
    $user_name = $_SESSION['admin_username']; // Get the admin_username before destroying the session
    ...
    function insertActivityLog($connection, $user_name, $activity, $description) {
        ...
        $stmt->bind_param("sss", $user_name, $activity, $description); // Correct binding type for admin_username
        $stmt->execute();
        $stmt->close();
    }
